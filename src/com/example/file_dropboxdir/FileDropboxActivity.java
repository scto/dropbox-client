...
public class FileDropboxActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int index,
				...
				if (listExplorer.get(index).isDir) {
					new OnClickForward(instance, FileDropboxActivity.this,
							index).execute();
				}
			}
		});
		...
		case 2:
			bttSelect.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					new OnMovingItem(instance, FileDropboxActivity.this)
							.execute();
				}
			});
			break;
		...
		case 4:
			...
			bttSelect.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View v) {
					new OnUploadItem(FileDropboxActivity.this, pathFile,
							instance).execute();
		...
		bttCancel.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				finish();
				Intent fileExplorer = new Intent(FileDropboxActivity.this,
						ExplorerActivity.class);
				FileDropboxActivity.this.startActivity(fileExplorer);
			}
		});
	}
	...
	public void onBackPressed() {
		if (!FileDropbox.getInstance().getPath().equals(MainActivity.ROOT)) {
			new OnClickBackward(instance, FileDropboxActivity.this).execute();
		} else {
			this.finish();
			instance.goForward(MainActivity.ROOT);
			Intent fileExplorer = new Intent(FileDropboxActivity.this,
