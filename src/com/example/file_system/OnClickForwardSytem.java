...
public class OnClickForwardSytem implements OnItemClickListener {

	private FileSystem fileSystem;
	private Activity activity;

	public OnClickForwardSytem(FileSystem fileSystem, Activity activity) {
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int index, long arg3) {
		...
		if (fileSystem.goForward(path)) {
			if (fileSystem.getListExplorer().isEmpty()) {
