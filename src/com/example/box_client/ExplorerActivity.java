...
public class ExplorerActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ExplorerAdapter adapter = new ExplorerAdapter(this, listTitles,
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int index,
				...
				if (listExplorer.get(index).isDir) {
					new OnClickForward(explorer, ExplorerActivity.this, index)
							.execute();
				}
			}
		});

		list.setOnItemLongClickListener(new OnLongClickOptions(this));
	}
	...
	public void onBackPressed() {
		if (!Explorer.getInstance().getPath().equals(MainActivity.ROOT)) {
			new OnClickBackward(explorer, ExplorerActivity.this).execute();
		} else {
			this.finish();
		}
	}
	...
	private void renameListener(String fileName, String dir) {
		...
		// Init
		custom = new Dialog(ExplorerActivity.this);
		...
		bttSave.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (name.equals("")) {
					...
					new ContextItemSelector(explorer, ExplorerActivity.this, 1,
							name, directory).execute();
					s = "Rename Successfully!";
				}
				Toast.makeText(ExplorerActivity.this, s, 3000).show(); // Note
																		// user
				custom.dismiss();
			}
		});
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case 0:
			// Delete
			new ContextItemSelector(explorer, ExplorerActivity.this, id,
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    ...
	    switch (item.getItemId()) {
	        case R.id.btt_grid:
	    		finish();
	    		Intent gridView = new Intent(this, GridviewActivity.class);
